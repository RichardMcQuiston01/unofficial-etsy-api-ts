 ...
 * Do not edit openapi.ts by hand — rerun `npm run codegen`.
 */
...
export interface components {
  schemas: {
    ...
    ShopListingWithAssociations: {
      ...
      views?: number;
      personalization?:
        | components["schemas"]["Etsy_Modules_ListingPersonalization_Api_Resources_OpenApi_ListingPersonalization"]
        | null;
  ...
  getListing: {
    parameters: {
      query?: {
        ...
        includes?: (
          "Images" | "Shop" | "User" | "Translations" | "Videos" | "Personalization" | "BuyerPrice"
        )[];
